...
:::{.rmdtip}
You can find more examples of charts and graphics at [R Charts](https://kaisamng.shinyapps.io/Ch6_Boxplot_Example/)
:::
...
**Your turn!** The following boxplot was supposed to graph the `PRCP` variable (representing amount of snow/rainfall in inches), grouped by `month`, but is completely messed up. Fix it so that:
  + your graph `PRCP`, grouped by `month`
...
<iframe style="margin:0 auto; min-width: 100%;" id="ch2-4-exercises" class="interactive" src="https://kaisamng.shinyapps.io/Ch6_Boxplot_Example/" scrolling="no" frameborder="no">
...
<iframe style="margin:0 auto; min-width: 100%;" id="ch2-4-exercises" class="interactive" src="https://kaisamng.shinyapps.io/Ch6_par_Example/" scrolling="no" frameborder="no">
...
<iframe style="margin:0 auto; min-width: 100%;" id="ch2-4-exercises" class="interactive" src="https://kaisamng.shinyapps.io/Ch5_to_6_Exercises/" scrolling="no" frameborder="no">
