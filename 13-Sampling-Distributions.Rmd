...
<div>
```{r, echo=FALSE}
knitr::include_graphics("resources/images/13-Sampling-Distributions/zscores_1.png")
```
</div>
...
knitr::include_graphics("resources/images/13-Sampling-Distributions/zscore_def.png")
```
...
<div>
```{r, echo=FALSE}
knitr::include_graphics("resources/images/13-Sampling-Distributions/galton_board.gif")
...
```{r, echo=FALSE}
knitr::include_graphics("resources/images/13-Sampling-Distributions/empirical_rule.png")
```
...
<div>
```{r, echo=FALSE}
knitr::include_graphics("resources/images/13-Sampling-Distributions/empirical_rule_1.png")
```
</div>
...
```{r, echo=FALSE}
knitr::include_graphics("resources/images/13-Sampling-Distributions/SNP.png")
```
...
## Solving for a z-score given a probability

We found the probabilities given the z-score—but we sometimes need the reverse. Here, you are given the area/probability and asked to find the corresponding data value.  
