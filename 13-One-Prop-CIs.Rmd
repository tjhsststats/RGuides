...
> We check that $np = 1029(0.48)= 494 \ge 10$ and $n(1-p) = 1029(1-0.48) =535 \ge 10$. Since both are greater than 10

> **Independent**: If our is sample size $n=1029$ is exactly 10% of the population, then that means the population size is $10*1029=10290$. Given that we know that there are way more than 10,290 adults in the U.S., it is reasonable to assume that our sample size is less than 10% of the population.
...
Unfortuntately, R doesn't have a built in command for calculating a one proportion Z-Interval automatically, but it is quite simple to do through computer.
...
$$ \text{Margin of Error}= \\ \text{qnorm} * \sqrt{\frac{0.48(1-0.58)}{1029}} \\= 0.036231 $$
...
```{r}
moe<- qnorm(0.99) * sqrt((0.48)*(1-0.48)/1029)
moe
```
