...
kable_styling(scroll_box(knitr::kable(Flowers, booktabs= TRUE, caption= "The Flowers Dataset"), width="500px", height="500px"), position="center")
```
...
```{r, echo=FALSE, fig.align='center'}
kable_styling(scroll_box(knitr::kable(Flowers_long, caption="Flowers Dataset, Long-Form Data"), height="600px"), position="center")
```
