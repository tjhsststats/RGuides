...
**XLSX** and **CSV** files are how many datasets are stored. They open through the Excel app. You can tell that they are Excel from its icon: ![]("https://gitcdn.link/cdn/kaisamng/RGuides/main/resources/images/00-Getting-Started/XLSX_File.png")
